  ...
  technology: {
    ...
    navLinks: [
      ...
      { label: 'Blog', href: '/blog', dropdown: [
        ...
        { label: 'AI Agents', href: '/blog/category/ai-agents', description: 'Architecture, use cases, deployment' },
        { label: 'Case Studies', href: '/blog/category/case-studies', description: 'Project stories and client impact' },
        { label: 'Engineering', href: '/blog/category/engineering', description: 'Deep technical guides' },
        { label: 'Newsletter', href: '/blog/newsletter', description: 'Monthly digest — curated by AI' },
      ]},
