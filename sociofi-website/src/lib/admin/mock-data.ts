...
import type { Submission, Contact, ContactActivity, PipelineEntry, CalendarEntry, AgentConfig, ApprovalItem, AgentRun, NewsletterIssue, NewsletterSubscriber, SubscriberList, ServiceTicket, VenturesApplication, Course, Workshop, CourseEnrollment, SCARLCohort } from '@/lib/admin/types'
