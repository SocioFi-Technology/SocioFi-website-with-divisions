  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px', position: 'relative' }}>
          ...
          >
            ...
            >
              Practical Education for Non-Technical Founders
            </h1>
            ...
            >
              Guides, tutorials, and business insight for people building with AI — without a
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          ...
          {filteredPosts.length > 0 ? (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
              <style>{`@media (max-width:900px){.academy-blog-grid{grid-template-columns:1fr 1fr!important}}@media (max-width:600px){.academy-blog-grid{grid-template-columns:1fr!important}}`}</style>
            ...
            <p style={{ fontFamily: 'var(--font-body)', color: 'var(--text-muted)', textAlign: 'center', padding: '60px 0' }}>
              No articles in this category for Academy yet.
            </p>
          )}
      ...
      <section style={{ padding: '60px 0 80px', background: 'var(--bg-2)', borderTop: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          <BlogNewsletter accentColor={ACCENT} title="Learn alongside us. Monthly." subtitle="One digest of the best educational content from Academy — curated for non-technical founders building with AI." />
        </div>
      </section>
    </>
  );
