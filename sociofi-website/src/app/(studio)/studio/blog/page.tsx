...
export default function StudioBlogPage() {
  ...
  const featuredPost = allDivisionPosts[0];
  ...
  return (
    <>
      ...
      {/* ── Articles ─────────────────────────────────────────────────────── */}
      <section style={{ padding: '60px 0 100px', background: 'var(--bg-2)', borderTop: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          ...
          {filteredPosts.length > 0 ? (
            ...
            <p style={{ fontFamily: 'var(--font-body)', color: 'var(--text-muted)', textAlign: 'center', padding: '60px 0' }}>No articles in this category for Studio yet.</p>
          )}
      ...
      <section style={{ padding: '60px 0 80px', background: 'var(--bg)', borderTop: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          <BlogNewsletter accentColor={ACCENT} />
        </div>
      </section>
    </>
  );
