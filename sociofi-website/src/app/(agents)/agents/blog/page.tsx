...
const ACCENT = '#8B5CF6';
const DIVISION = 'agents';

export default function AgentsBlogPage() {
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px', position: 'relative' }}>
          ...
          >
            ...
            >
              Practical guides, honest comparisons, and real-world results from deploying AI
      ...
      <section style={{ padding: '60px 0 100px', background: 'var(--bg)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          ...
          {filteredPosts.length > 0 ? (
            ...
            >
              <style>{`
                @media (max-width: 900px) { .agents-grid { grid-template-columns: 1fr 1fr !important; } }
            ...
            <p style={{ fontFamily: 'var(--font-body)', color: 'var(--text-muted)', textAlign: 'center', padding: '60px 0' }}>
              No articles in this category for Agents yet.
            </p>
          )}
