...
const MOCK_TEAM_MEMBERS: TeamMember[] = [
  {
    id: 'tm1', name: 'Arifur Rahman', email: 'arifur@sociofitechnology.com', role: 'super_admin',
  ...
  {
    id: 'tm2', name: 'Kamrul Hasan', email: 'kamrul@sociofitechnology.com', role: 'super_admin',
    divisions: ['studio', 'services', 'labs', 'products', 'academy', 'ventures', 'cloud'],
  ...
  {
    id: 'tm3', name: 'Nadia Islam', email: 'nadia@sociofitechnology.com', role: 'division_lead',
  ...
  {
    id: 'tm4', name: 'Rafi Hossain', email: 'rafi@sociofitechnology.com', role: 'division_lead',
  ...
  {
    id: 'tm5', name: 'Tania Begum', email: 'tania@sociofitechnology.com', role: 'editor',
    divisions: ['studio'],
  ...
  {
    id: 'tm6', name: 'Jahir Ahmed', email: 'jahir@sociofitechnology.com', role: 'editor',
  ...
  {
    id: 'tm7', name: 'Sara Mila', email: 'sara@sociofitechnology.com', role: 'viewer',
    divisions: ['labs'],
  ...
  {
    id: 'tm8', name: 'Omar Farouk', email: 'omar@sociofitechnology.com', role: 'editor',
    divisions: ['services'],
